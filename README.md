...
A Mechatronics engineering project that uses sensors, actuators, and Arduino to detect and sort waste into categories: **Plastic**, **Metal**, and **Organic** — promoting automation in environmental sustainability.
...
- 🔍 Waste type detection using sensors
- ⚙️ Servo motors for flap/door control
- 🌀 Stepper motor for rotating platform/bin alignment
- 🧠 Logic control with Arduino Uno
- 🖥️ Proteus simulation and SolidWorks mechanical design
...
| Servo Motor          | 2–3      | Used for sorting mechanism        |
...
│   └── waste\_sorting.ino
├── circuits/
│   └── proteus\_simulation.dsn
├── 3d\_model/
│   └── solidworks\_assembly.SLDASM
├── images/
│   └── robot\_diagram.png
├── README.md
...
This project is open-source under the **MIT License** — use it freely for academic or environmental innovations.
